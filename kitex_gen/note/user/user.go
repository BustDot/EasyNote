...
func (p *CreateUserResp) Field1DeepEqual(src *base.BaseResp) bool {
...
func (p *MGetUserReq) GetUserIds() (v []int64) {
	return p.UserIds
}
func (p *MGetUserReq) SetUserIds(val []int64) {
	p.UserIds = val
}
...
func (p *MGetUserResp) Field2DeepEqual(src *base.BaseResp) bool {
...
func (p *CheckUserResp) Field2DeepEqual(src *base.BaseResp) bool {
